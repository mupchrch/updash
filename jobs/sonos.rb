...
speaker_ip_addr = ENV['SONOS_IP_ADDR']
...
# temp fix, discovery not working
player = Sonos::Device::Speaker.new(speaker_ip_addr)
def player.group_master
  OpenStruct.new(ip: speaker_ip_addr)
end
# end temp fix
